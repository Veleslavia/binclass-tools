...
def curve_PR_plot(true_y, predicted_proba, beta = 1, n_thresholds = None, title = "Precision Recall Curve"):
    ...
    if n_thresholds:
        indices = np.linspace(0, len(thresholds) - 1, n_thresholds, dtype=int).tolist()
        listTr = thresholds[indices]
